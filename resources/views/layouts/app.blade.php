...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><img src="http://localhost/noosa-snbt/public/assets/dist/img/logo-noosa.png" class="img-noosa-icon" style="width: 45px;height: 30px;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="http://localhost/noosa-snbt/public/assets/dist/img/logo-noosa.png" class="img-noosa-icon" style="width: 80px;height: 45px;"><b> Noosa</b> SNBT</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                  ...
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        ...
                        @else
                          <img src="{{ url('/assets/dist/img/icon-login.png') }}" class="img-circle" alt="User Image">
                        @endif
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              @else
                <img src="{{ url('/assets/dist/img/icon-login.png') }}" class="user-image" alt="User Image">
              @endif
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @elseif($user->status == 'S')
          ...
          <li class="{{ Request::is('siswa/ujian*') == true ? 'active' : '' }}"><a href="{{ url('siswa/ujian') }}">
            <i class="fa fa-desktop"></i> <span>Try Out SNBT</span></a>
          </li>
          <li class="{{ Request::is('siswa/materi*') == true ? 'active' : '' }}"><a href="{{ url('siswa/materi') }}">
            <i class="fa fa-book"></i> <span>Akses Materi Belajar</span></a>
          </li>
          <li class="{{ Request::is('siswa/video*') == true ? 'active' : '' }}"><a href="{{ url('siswa/video_materi') }}">
            <i class="fa fa-play-circle"></i> <span>Video Pembelajaran</span></a>
          </li>
        @endif
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2025 <a href="https://noosa.id/" target="_blank">Noosa SNBT</a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
